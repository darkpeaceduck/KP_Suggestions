...
public class getAllNear {
	...
	public static void insert(DBOperator db, String id)
			throws FuckupException, HttpStatusException, PageLoaderException, Exception {
	...
	public static void bfs(String start, DBOperator db, Integer depth)
			throws FuckupException, HttpStatusException, PageLoaderException, Exception {

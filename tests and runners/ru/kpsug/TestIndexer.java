...
public class TestIndexer {
	...
	private void forFilm(DBOperator db, String id) throws PageLoaderException {
		...
		// Film new_film = KpParser.parseFilm(PageLoader.loadFilm(new_id),
		// PageLoader.loadFilmSuggestions(new_id));
	...
	public void testDB() throws ClassNotFoundException, SQLException, IOException {
		...
		// Film film = KpParser.parseFilm(doc,
		// PageLoader.loadFilmSuggestions(id) );
	...
	public void test1() {
		...
		// film.setSuggestion_links(new ArrayList<String>(Arrays.asList("123",
		// "321")));
		// film.setId("12312312");
		// film.setName("vasya");
		// film.setRating("10.123");
		// film.setAnnotation("trololol l l ol ol o lo l o lo l");
		// TreeMap<String, ArrayList<String>> new_list = new TreeMap<String,
		// ArrayList<String>>();
	...
	public void test2() {
		// String s =
		// "(373314,453284)(373314,415379)(373314,401779)(373314,22292)(373314,452599)(373314,39864)(373314,251733)";

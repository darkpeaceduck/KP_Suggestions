...
public class ConnectionService extends Service {
    ...
    private class AssyncRequest{
        ...
        public void setCallback(AsyncTask<SuggestionsResult, Object, Object> callback) {
            this.callback = callback;
        }
    }
    ...
    private class ConnectTaskLoop implements Runnable{
        ...
        private void reconnect() throws InterruptedException{
            while(true){
                ...
                try {
                    ...
                    System.out.println("failed connected to db server with io host");
                    try {
        ...
        private SuggestionsResult send(Request request) throws InterruptedException{
    ...
    private class AloneFilmProvider extends AsyncTask<SuggestionsResult, Object, Object>{
    ...
    public void requestToDb( String id, Integer level, AsyncTask<SuggestionsResult, Object, Object> callback){
        looper.send(new AssyncRequest(new Request(0, level, id), callback));
    }
    
    private void runFilmGetterCallBack( final AsyncTask<Film, Object, Object> callback, Film film){
        synchronized (callback) {
    ...
    private void requestToKp(final String id, final AsyncTask<Film, Object, Object> callback){

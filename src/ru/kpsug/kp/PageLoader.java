...
public class PageLoader {
	...
	public static Document loadFilmWithCookies(String id, TreeMap<String, String> cookies)
			throws PageLoaderException, HttpStatusException {
	...
	public static Document loadFilmSuggestionsWithCookies(String id, TreeMap<String, String> cookies)
			throws PageLoaderException, HttpStatusException {
	...
	public static Document loadMainSearch(String token) throws PageLoaderException, HttpStatusException {
		return getWrapper(
				Jsoup.connect(KpPath.makeMainSearchLink(convertToUtf(token))).timeout(timeout).userAgent(user_agent));
	}
